...
<%
	...
	*/
	...
	// 기본 시간은 30분으로 세팅되어 있고(디폴트 세팅) 바꾸면 초 단위로 입력해 바꿔줄 수 있습니다.
	...
	session.invalidate();		// 세션 기능 파괴 (null값도 안나옴) 로그아웃기능에 많이 사용함.
